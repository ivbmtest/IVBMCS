                        ...
                        // function checkInput() {
                        //   // Get the input value
                        //   var inputValue = document.getElementById('otp_area').value;
                    
                        //   // Get the submit button
                        //   var submitButton = document.getElementById('otp_btn');
                    
                        //   // Check if the input is empty
                        //   if (inputValue.trim() === '') {
                        //     // If empty, disable the button and make its background transparent
                        //     submitButton.disabled = true;
                        //     submitButton.style.backgroundColor = 'white';
                        //     submitButton.style.color = 'rgba(12, 8, 8, 0.631)';
                        //   } else {
                        //     // If not empty, enable the button and give it a background color
                        //     submitButton.disabled = false;
                        //     submitButton.style.backgroundColor = '#00194c'; // Set your desired background color here
                        //     submitButton.style.color = 'white'; // Set your desired background color here
                        //   }
                        // }
...
function moveToNextInput(currentInput) {
  ...
  function updateSubmitButton() {
    ...
    submitButton.disabled = !(digit1 && digit2 && digit3 && digit4 && digit5 && digit6);
  }
...
const countries = [
    ...
    input_box = document.querySelector('.select_cou'),
...
if (num[0] == '+'){
    ...
    if (isNumeric) {
       ...
       document.getElementById('error').innerHTML=""
        ...
        document.getElementById('error').innerHTML="must be number"
