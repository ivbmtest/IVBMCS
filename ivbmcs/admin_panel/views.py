...
def select_my_task(request,id):
    ...
    if request.method == 'POST':
        ...
        message = f'your request for {task_instance.service} is taken by {current_user}'
    ...
    user_notification.objects.get_or_create(message=message, timestamp=time,recepient=user_details, service=service_instance,sender=request.user)
