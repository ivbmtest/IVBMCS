"""
Django settings for ivbmcs project.
...
SECRET_KEY = 'django-insecure-2)gq7#w55w0z)#*vjy5g$)!)@0vy6ooh@tb0vemy1(m^uk!0=d'
...
WSGI_APPLICATION = 'ivbmcs.wsgi.application'
